...
public class CmdUtils {
	 ...
	 * @return 执行结果
	 */
	public static exp.libs.utils.os.CmdResult execute(String cmd) {
	 ...
	 * @return 执行结果
	 */
	public static exp.libs.utils.os.CmdResult execute(String cmd, boolean debug) {
		exp.libs.utils.os.CmdResult cmdRst = exp.libs.utils.os.CmdResult.DEFAULT;
		try {
	 ...
	 * @return 执行结果
	 */
	public static exp.libs.utils.os.CmdResult execute(String[] cmds) {
	 ...
	 * @return 执行结果
	 */
	public static exp.libs.utils.os.CmdResult execute(String[] cmds, boolean debug) {
		exp.libs.utils.os.CmdResult cmdRst = exp.libs.utils.os.CmdResult.DEFAULT;
		try {
	...
	private static exp.libs.utils.os.CmdResult _execute(Process process, boolean debug) {
		exp.libs.utils.os.CmdResult cmdRst = new exp.libs.utils.os.CmdResult();
		try {
			...
			cmdRst = exp.libs.utils.os.CmdResult.DEFAULT;
