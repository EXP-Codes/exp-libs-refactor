...
import exp.libs.utils.flow.FileFlowReader;
...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static boolean copyFile(String srcPath, String snkPath) {
		...
		if(StrUtils.isNotTrimEmpty(srcPath, snkPath)) {
			...
			isOk = copyFile2(srcFile, snkFile);
		}
		return isOk;
	}
	 ...
	 * @param snkFile 目标文件
	 */
	public static boolean copyFile2(File srcFile, File snkFile) {
		boolean isOk = true;
		try {
	...
	public static boolean copyDirectory(String srcPath, String snkPath) {
		...
		if(StrUtils.isNotTrimEmpty(srcPath, snkPath)) {
			File srcFile = new File(srcPath);
			File snkFile = new File(snkPath);
			isOk = copyDirectory2(srcFile, snkFile);
		}
		return isOk;
	}
	 ...
	 * @param snkDir 目标目录
	 */
	public static boolean copyDirectory2(File srcDir, File snkDir)  {
		boolean isOk = true;
		try {
	...
	public static boolean moveFile(String srcPath, String snkPath) {
		...
		if(StrUtils.isNotTrimEmpty(srcPath, snkPath)) {
			File srcFile = new File(srcPath);
			File snkFile = new File(snkPath);
			isOk = moveFile2(srcFile, snkFile);
		}
		return isOk;
	}
	 ...
	 */
	public static boolean moveFile2(File srcFile, File snkFile) {
		boolean isOk = true;
		try {
	...
	public static boolean moveDirectory(String srcPath, String snkPath) {
		...
		if(StrUtils.isNotTrimEmpty(srcPath, snkPath)) {
			File srcFile = new File(srcPath);
			File snkFile = new File(snkPath);
			isOk = moveDirectory2(srcFile, snkFile);
		}
		return isOk;
	}
	 ...
	 * @param snkDir 目标位置
	 */
	public static boolean moveDirectory2(File srcDir, File snkDir)  {
		boolean isOk = true;
		try {
