package exp.libs.sock.websock;

import exp.libs.utils.concurrent.ThreadUtils;
import exp.libs.utils.num.BODHUtils;
import exp.libs.sock.websock.bean.Frame;
import exp.libs.sock.websock.interfaze.IHandler;
import exp.libs.sock.websock.interfaze.ISession;
...
class _WebSockSession extends WebSocketClient implements ISession {
	 ...
	 */
	protected _WebSockSession(String wsURL, Draft draft, IHandler handler, 
			int connTimeout, int keepTimeout) throws Exception {
