...
import exp.libs.db.redis.bean.RedisList;
import exp.libs.db.redis.bean.RedisMap;
import exp.libs.db.redis.bean.RedisObj;
import exp.libs.db.redis.bean.RedisSet;
