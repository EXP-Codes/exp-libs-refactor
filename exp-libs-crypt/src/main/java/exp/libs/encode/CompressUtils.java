...
public class CompressUtils {
	...
	public static boolean toGZip(String srcPath, String gzipPath) {
		...
		try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream(srcFile));
			 GzipCompressorOutputStream gos = new GzipCompressorOutputStream(new FileOutputStream(gzipPath)); ) {
			int cnt = -1;
	...
	public static boolean toBZ2(String srcPath, String bzPath) {
		...
		try (InputStream is = new FileInputStream(srcFile);
			 OutputStream os = new FileOutputStream(new File(bzPath));
	...
	public static boolean unGZip(String gzipPath, String snkDir) {
		...
		try (GZIPInputStream gis = new GZIPInputStream(new FileInputStream(gzipPath));
			 ...
			 FileOutputStream fos = new FileOutputStream(snkDir); ) {
			int cnt = 0;
			byte[] buf = new byte[UnitUtils._1_MB];
	...
	public static boolean unBZ2(String bzPath, String snkDir) {
		boolean isOk = true;
		FileUtils.createDir(snkDir);
		try (BZip2CompressorInputStream bzis = new BZip2CompressorInputStream(new FileInputStream(bzPath));
